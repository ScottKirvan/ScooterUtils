...
public:
	 ...
	 */
	UPROPERTY(EditAnywhere, config, Category = "Screen Real Estate", meta = (DisplayName = "Persistent Editor Scale (Editor Preferences > General > Appearance: Application Scale)", ClampMin = 0.5, ClampMax = 3.0))
